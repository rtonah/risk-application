<nav id="sidebarMenu" class="sidebar d-lg-block bg-gray-800 text-white collapse" data-simplebar>
  <div class="sidebar-inner px-2 pt-3">
    ...
    <ul class="nav flex-column pt-3 pt-md-0">
     ...
     <li class="nav-item">
      <span
        class="nav-link {{ Request::segment(1) !== 'tickets' ? 'collapsed' : '' }} d-flex justify-content-between align-items-center"
      ...
      <div class="multi-level collapse {{ Request::segment(1) === 'tickets' ? 'show' : '' }}" id="submenu-tickets">
        <ul class="flex-column nav">
          ...
          <li class="nav-item {{ Request::is('tickets/gestion*') ? 'active' : '' }}">
