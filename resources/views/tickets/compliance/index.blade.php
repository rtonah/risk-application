<x-layouts.app>
        ...
        <div class="row justify-content-between align-items-center">
            <div class="col-12 col-md-6">
                <div class="input-group me-2 fmxw-400">
                    ...
                    <input type="text" id="search" class="form-control" placeholder="Rechercher un ticket">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card card-body shadow border-0 table-wrapper table-responsive">
        <div id="tickets-table">
            @include('tickets.compliance.partials.table', ['tickets' => $tickets])
        </div>
    </div>
    <script>
        document.getElementById('search').addEventListener('input', function () {
            ...
            fetch(`{{ route('compliance.filter') }}?query=${encodeURIComponent(query)}`)
