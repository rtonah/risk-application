...
#.. Admin Pannel et setting environnement
Route::middleware(['auth', 'role:admin'])->group(function () {
    Route::get('/admin/settings', function () {
        return view('admin.settings.index');
    })->name('admin.settings');

    Route::get('/admin/cbs-config', function () {
        return view('admin.settings.cbs-config');
    })->name('admin.cbs-config');
});

#.. Gestion rôle et permission
Route::middleware(['auth', 'role:admin'])->group(function () {
